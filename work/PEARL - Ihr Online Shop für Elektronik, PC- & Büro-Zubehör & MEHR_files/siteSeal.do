...
function ss_open_sub(){
  ...
  ss_url_p1          = "b361df58"
  ss_url_p2          = "669542469271434afb81686df5632a78ca9626da31c4011d8c2417509a816d6feb38727bcd9224fc649543408e2e0710a5"
  ss_url_p3          = "1e04a9bde6e06a8f425b76867ab79ef664c5b271"
...
function writeFlash() {
  ...
  var str =
    ...
    "<PARAM NAME='flashVars' VALUE='timeText=11:53:23(UTC)'>" +
    "<PARAM NAME='wmode' VALUE='transparent'>" +    
    "<EMBED src='" + ss_flashLocation + "' FlashVars='timeText=11:53:23(UTC)'" +
    " WIDTH='" + ss_width + "'" +
    " HEIGHT='" + ss_height + "'" +
    " NAME='ss_imgTag'" +
